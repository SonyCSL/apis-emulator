...
以下の(1)～(4)の処理を繰り返しコンピュータ上で生成された蓄電システム上で太陽光発電、住宅の消費、蓄電池への充放電等の電力の流れをエミュレーションする。

1.  蓄電池の残容量によってUPSの動作モードを変更する。残容量が少ない場合には

> モードを変更しバイパスして系統電源を住宅へ供給し系統電源から蓄電池へ充電する。

1.  蓄電システムの電力ロスや発電と消費から蓄電池に充放電される電力を計算し

> アップデートする。

1.  “Set Acceleration Rateボタン”で設定された値だけエミュレーション世界の時間を進める。(詳細は“4.1 表示部”を参照のこと)

2.  (3)の時間経過による太陽光発電と住宅消費を計算し蓄電池の残容量をアップデートする。
...
<table><thead><tr class="header"><th>emu</th><th>charge_discharge_power</th><th>蓄電池の充放電電力 [W] (絶対値)</th></tr></thead><tbody><tr class="odd"><td></td><td>rsoc</td><td>表示や、制御に使用される蓄電池の相対残容量 (%)</td></tr><tr class="even"><td></td><td>battery_rsoc</td><td>リアルな蓄電池の相対残容量 (%)</td></tr><tr class="odd"><td></td><td>battery_voltage</td><td>蓄電池電圧 [V]</td></tr><tr class="even"><td></td><td>battery_current</td><td>蓄電池電流 [A]</td></tr><tr class="odd"><td></td><td>pvc_charge_voltage</td><td>PVC出力電圧 [V]</td></tr><tr class="even"><td></td><td>pvc_charge_current</td><td>PVC出力電流 [A]</td></tr><tr class="odd"><td></td><td>pvc_charge_power</td><td>PVC出力電力 [W]</td></tr><tr class="even"><td></td><td>ups_input_voltage</td><td>UPS入力電圧 [V]</td></tr><tr class="odd"><td></td><td>ups_output_voltage</td><td>UPS出力電圧 [V]</td></tr><tr class="even"><td></td><td>ups_output_current</td><td>UPS出力電流 [A]</td></tr><tr class="odd"><td></td><td>ups_output_power</td><td>UPS出力電力 [W]</td></tr><tr class="even"><td></td><td>ups_output_frequency</td><td>UPS出力周波数 [Hz]</td></tr><tr class="odd"><td></td><td>ups_operation_mode.parameter</td><td>商用電力利用割合</td></tr><tr class="even"><td></td><td>ups_operation_mode.mode</td><td>UPS動作モード</td></tr><tr class="odd"><td></td><td>ups_operation_mode.stop_mode</td><td><p>蓄電池が空になった後のUPS動作モード</p><ol type="1"><li><p>UPS, 2. バイパス</p></li></ol></td></tr><tr class="even"><td></td><td>ups_operation_schedule</td><td>UPS動作スケジュール</td></tr><tr class="odd"><td></td><td>system_time.year</td><td>EMUのシステム時計の年</td></tr><tr class="even"><td></td><td>system_time.month</td><td>EMUのシステム時計の月</td></tr><tr class="odd"><td></td><td>system_time.day</td><td>EMUのシステム時計の日</td></tr><tr class="even"><td></td><td>system_time.hour</td><td>EMUのシステム時計の時間</td></tr><tr class="odd"><td></td><td>system_time.minute</td><td>EMUのシステム時計の分</td></tr><tr class="even"><td></td><td>dischargeable_time.hour</td><td>蓄電池から放電可能な時間</td></tr><tr class="odd"><td></td><td>dischargeable_time.minute</td><td>蓄電池から放電可能な分</td></tr><tr class="even"><td>dcdc</td><td>status.status</td><td>DC/DC Converterステータス</td></tr><tr class="odd"><td></td><td>status.statusName</td><td>DC/DC Converter ステータス情報</td></tr><tr class="even"><td></td><td>status.alarm</td><td>DC/DC Converterアラーム番号</td></tr><tr class="odd"><td></td><td>status.stateAlarm</td><td>DC/DC Converterアラーム情報</td></tr><tr class="even"><td></td><td>status.runningState</td><td>DC/DC Converter動作ステータス</td></tr><tr class="odd"><td></td><td>status.operationMode</td><td>動作モードステータス</td></tr><tr class="even"><td></td><td>powermeter.p1</td><td><p>蓄電システム及び住宅の消費電力 [W]</p><p>(詳細は図4-2参照のこと)</p></td></tr><tr class="odd"><td></td><td>powermeter.p2</td><td><p>蓄電システムへの消費電力 [W]</p><p>(詳細は図4-2参照のこと)</p></td></tr><tr class="even"><td></td><td>powermeter.v1</td><td>powermeter.p1位置の電圧 [V]</td></tr><tr class="odd"><td></td><td>powermeter.i1</td><td>powermeter.p1位置の電流 [A]</td></tr><tr class="even"><td></td><td>powermeter.kwh1</td><td>powermeter.p1の電力量 [kWh]</td></tr><tr class="odd"><td></td><td>powermeter.kwh2</td><td>powermeter.p2の電力量 [kWh]</td></tr><tr class="even"><td></td><td>meter.vg</td><td>DC Grid電圧 (V)</td></tr><tr class="odd"><td></td><td>meter.ig</td><td>DC Grid電流 (A)</td></tr><tr class="even"><td></td><td>meter.wg</td><td>DC Grid 電力 (W)</td></tr><tr class="odd"><td></td><td>meter.vb</td><td>蓄電池電圧 (V)</td></tr><tr class="even"><td></td><td>meter.ib</td><td>蓄電池電流 (A)</td></tr><tr class="odd"><td></td><td>meter.wb</td><td>蓄電池電力 (W)</td></tr><tr class="even"><td></td><td>meter.tmp</td><td>内部温度 (℃)</td></tr><tr class="odd"><td></td><td>vdis.dvg</td><td>DC Grid目標電圧値 (V)</td></tr><tr class="even"><td></td><td>vdis.drg</td><td>DC Grid Droop率 (%)</td></tr><tr class="odd"><td></td><td>param.dig</td><td>DC Grid上限電流 (A)</td></tr><tr class="even"><td></td><td>param.ogv</td><td>DC Grid過電圧閾値 (V)</td></tr><tr class="odd"><td></td><td>param.ugv</td><td>DC Grid低電圧閾値 (V)</td></tr><tr class="even"><td></td><td>param.cib</td><td>Battery上限電流 (A)</td></tr><tr class="odd"><td></td><td>param.obv</td><td>Battery過電圧閾値 (V)</td></tr><tr class="even"><td></td><td>param.ubv</td><td>Battery低電圧閾値 (V)</td></tr><tr class="odd"><td>oesunit</td><td>on</td><td><p>旧制御システムで使われたパラメータ</p><p>APIS 用Emulatorとしては不使用</p></td></tr><tr class="even"><td></td><td>ip</td><td>APISインストールデバイスのIPv4 Address</td></tr><tr class="odd"><td></td><td>display</td><td>蓄電システムの画面表示情報</td></tr><tr class="even"><td></td><td>ipv6_ll</td><td>APISインストールデバイスのIPv6のリンクローカルアドレス</td></tr><tr class="odd"><td></td><td>ipv6_g</td><td>APISインストールデバイスのIPv6のグローバルアドレス</td></tr><tr class="even"><td></td><td>mac</td><td>APISインストールデバイスのmacアドレス</td></tr><tr class="odd"><td></td><td>sn</td><td>APISインストールデバイスのデバイスのシリアルナンバー</td></tr><tr class="even"><td></td><td>id</td><td>蓄電システムID</td></tr><tr class="odd"><td></td><td>budo</td><td><p>旧制御システムで使われたパラメータ</p><p>APIS用Emulatorとしては不使用</p></td></tr><tr class="even"><td>time</td><td>apis-mainノードの時間</td><td>Emulator上での蓄電システムの時間</td></tr></tbody></table>
...
&lt;例&gt;CSVファイルなどの入力情報が読み込まれない場合等。

3\. WARNING

→警告として知らせる目的で用いられるLevelである。

&lt;例&gt; Web APIで指定されたパラメータが不明だった場合等。

4.INFO

→実行中の正常系の情報を出力する際に用いられるLevelである。

　　&lt;例&gt; “ramping up finish”などの挙動情等を知らせる場合等。

5.DEBUG　

→Debug目的で用いられるLog Levelである。

&lt;例&gt; EmulatorのDebug目的で使われる情報等。
...
<table><thead><tr class="header"><th>ソフトウェア</th><th>バージョン</th><th>ライセンス</th><th>コード改変</th></tr></thead><tbody><tr class="odd"><td>Python</td><td>2.7.18</td><td>PSL License</td><td>無</td></tr><tr class="even"><td>Requests</td><td>2.4.3</td><td>Apache License2.0</td><td>無</td></tr><tr class="odd"><td>pandas</td><td>0.14.1</td><td>BSD License</td><td>無</td></tr><tr class="even"><td>Bottle</td><td>0.12.8</td><td>MIT License</td><td>無</td></tr><tr class="odd"><td>jQuery</td><td>1.7.2</td><td><p>MIT Licenser or GPL v2 License</p><p>のどちらか選択</p></td><td>無</td></tr></tbody></table>
